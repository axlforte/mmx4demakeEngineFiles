...
#region Bosses Variables
	...
	global.boss_defeated[e_boss.storm_eagle] = true;
#endregion
#region Bosses Info
	...
	["STORM EAGLE", spr_storm_eagle_icon, spr_7th_airborne_unit, rm_road_to_stingray, obj_storm_eagle_intro];
	...
	["LAUNCH OCTOPUS", spr_launch_octopus_icon, spr_launch_octopus_map, rm_trains_weee, obj_launch_octopus_intro];
#endregion
